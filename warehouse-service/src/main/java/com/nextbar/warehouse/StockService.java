...
public class StockService {
    ...
    public StockResponse addStock(String beverageType, int quantity) {
        ...
        /**
         * Reserve stock for a planned event.
         */
        @Transactional
        public StockResponse reserveStock(String beverageType, int quantity) {
        log.info("Reserving stock: type={}, quantity={}", beverageType, quantity);
        ...
        log.info("Reserved {} units for {}, available: {}, reserved: {}",
            quantity, beverageType, stock.getQuantity(), stock.getReservedQuantity());
         ...
         */
        @Transactional
        public StockResponse releaseReservedStock(String beverageType, int quantity) {
        log.info("Releasing reserved stock: type={}, quantity={}", beverageType, quantity);
        ...
        log.info("Released {} reserved units for {}, available: {}, reserved: {}",
            quantity, beverageType, stock.getQuantity(), stock.getReservedQuantity());
        ...
        /**
         * Consume previously reserved stock when event starts.
         */
        @Transactional
        public StockResponse consumeReservedStock(String beverageType, int quantity) {
        log.info("Consuming reserved stock: type={}, quantity={}", beverageType, quantity);
        ...
        log.info("Consumed {} reserved units for {}, reserved: {}, used: {}",
            quantity, beverageType, stock.getReservedQuantity(), stock.getUsedQuantity());

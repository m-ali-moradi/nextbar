...
public class SupplyEventPublisher {
     ...
     */
    public void publishSupplyRequestUpdated(SupplyRequest request, int fulfilledQuantity) {
    ...
    /**
     * Backward-compatible overload that uses persisted fulfilled quantity.
     */
    public void publishSupplyRequestUpdated(SupplyRequest request) {
        publishSupplyRequestUpdated(request, request.getFulfilledQuantity());
    }

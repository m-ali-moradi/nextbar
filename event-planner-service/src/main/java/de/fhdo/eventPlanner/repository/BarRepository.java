...
public interface BarRepository extends JpaRepository<Bar, Long> {
    ...
    /**
     * Find all bars with event occupancy flag set.
     */
    List<Bar> findByEventOccupancyTrue();

    /**
     * Find bars by assigned staff.
     */
    List<Bar> findByAssignedStaffContainingIgnoreCase(String staffName);

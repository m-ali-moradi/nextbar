    ...
    <div class="modal-overlay" @click.self="$emit('close')">
      <div class="modal-content max-w-lg animate-scale-in">
        ...
        <div class="modal-header">
          <h3 class="text-xl font-bold text-slate-900">Add New Bar</h3>
          <button 
            @click="$emit('close')"
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const errorMessage = err instanceof Error ? err.message : 'Failed to add bar';

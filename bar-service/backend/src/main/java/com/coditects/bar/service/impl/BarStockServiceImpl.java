...
public class BarStockServiceImpl implements BarStockService {
    ...
    public List<BarStockItemDto> getStock(UUID barId) {
        ...
        // Fetch stock items for the bar, convert to DTOs, and sort by updatedAt descending.
        // sorted by updatedAt descending to show the most recently updated items first in the list in the UI

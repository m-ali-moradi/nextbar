...
public class BarDataInitializer implements ApplicationRunner {
    ...
    public BarDataInitializer(EventPlannerClient eventPlannerClient, BarService barService, BarStockService barStockService) {
...
//                    barStockService.addStock(item.id(), item.productId(), item.quantity());
//                }
            }
        } catch (Exception e) {
